<template>
  <div class="box">
    <img src="../imager/border1 (4).png" style="width: 100%;height:120%" alt="" />
    <div class="title">
      {{ name }}
    </div>
    <div class="toDaymin">
      ...
      <div :class="['li',index%2==0?'one':'two']" v-for="(item,index) in data.slice(0,7)" :key="index">
...
.box {
  ...
  .toDaymin {
   ...
   .li{
     ...
     .site{
       line-height: 20px;
       width: 35%;display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 3; overflow: hidden;
     }
   ...
   .headerLi{
     ...
     .two{
       background-color: rgba(3,198,232,.25);
     }
  }
}
</style>